...
//        System.out.println(save);
        ...
        menuDomain1.setAncestorCode("Layouts");
        menuDomain1.setIcon("icon-user");
        menuDomain1.setMenuCode("MenuList");
        menuDomain1.setMenuName("菜单列表");
        menuDomain1.setMenuUrl("showMenuList");
        menuDomain1.setParentCode("Layouts");
        menuDomain1.setSortStr("B4");
