...
import com.bootstrap.jimas.authority.MyShiroRealm;
...
//       filterChainDefinitionMap.put("/userLogin", "anon");
       filterChainDefinitionMap.put("/media/**", "anon");//anon 可以理解为不拦截
       filterChainDefinitionMap.put("/js/**", "anon");//anon 可以理解为不拦截
       ...
       // 如果不设置默认会自动寻找Web工程根目录下的"/login.jsp"页面
        ...
        // 登录成功后要跳转的链接
        shiroFilterFactoryBean.setSuccessUrl("/jimas");
        //未授权界面;
